const OurWorkProcessSteps = () => {
  const steps = [
    ...
    { title: "Debugging & Testing ", description: "Thoroughly test the project to identify and fix any issues." },
    ...
    { title: "Payment Processing", description: "Set up and process payment for the delivered project." },
    {
      title: "Project Closure",
      description: "Complete all remaining administrative tasks and officially close the project.",
    },
